...
<div class="container">
  <div class="middle-align">
    <?php
        $theme_lay = get_theme_mod( 'vw_construction_estate_theme_options','One Column');
            ...
            <div class="navigation">
              <?php
                  ...
                  the_posts_pagination( array(
                      'prev_text'          => __( 'Previous page', 'vw-construction-estate' ),
                      'next_text'          => __( 'Next page', 'vw-construction-estate' ),
                      'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'vw-construction-estate' ) . ' </span>',
                  ) );
              ?>
    ...
    <?php }else if($theme_lay == 'Grid Layout'){ ?>
        <div class="row">
          ...
          <div class="col-md-3" id="sidebar"><?php dynamic_sidebar('sidebar-1');?>
          </div>
        </div>
    <?php } ?>
    <div class="clearfix"></div>
